...
export const Modal = ({ isOpen, onClose, title, children, size = 'md' }) => {
  ...
  useEffect(() => {
    ...
    // Hide overflow to prevent background scrolling
    document.body.style.overflow = 'hidden';
    
    // Autofocus first interactive element on desktop
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={`relative w-full ${sizeClasses[size]} bg-white rounded-t-2xl shadow-2xl animate-modal-in max-h-[85dvh] sm:max-h-[90dvh] sm:rounded-2xl flex flex-col`} 
      ...
      >
        ...
        {/* Body */}
        <div className="overflow-y-auto overscroll-contain flex-1 px-4 py-4 sm:px-6 sm:py-5">
          {children}
        </div>
      </div>
    </div>
